    ...
    <el-card style="min-height: 870px;">
      ...
      <div>
        <el-table :data="paginationTableData" border height="611px" width="100%" size="small">
          ...
          <el-table-column prop="xmjs" label="项目介绍" min-width="150" align="center"></el-table-column>
    ...
    <modal :modalObj="dialogObj">
      <el-form ref="modalForm" :model="modalForm" :rules="rules" label-width="140px">
        <el-form-item label="筛查项目" prop="scxm">
          <el-input v-model="modalForm.scxm"></el-input>
        </el-form-item>
        <el-form-item label="项目介绍" prop="xmjs">
          <el-input type="textarea" v-model="modalForm.xmjs" resize="none"></el-input>
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        xmjs: [{ required: true, message: '项目介绍不能为空', trigger: ' ' }],
      },
      importModal: {
        title: '批量上传', // 标题
        isShow: false, // 是否显示
