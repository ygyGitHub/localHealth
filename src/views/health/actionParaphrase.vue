...
<template>
  <div>
    <el-card style="min-height: 870px;">
      <el-row>
        <el-col :span="20"><div>健康中国行动释义信息列表</div></el-col>
        <el-col :span="4">
      ...
      <div>
        <el-table :data="paginationTableData" border height="611px" width="100%" size="small">
          ...
          <el-table-column prop="xdsy" label="行动释义" min-width="150" align="center"></el-table-column>
    ...
    <modal :modalObj="dialogObj">
      <el-form ref="modalForm" :model="modalForm" :rules="rules" label-width="120px">
        ...
        <el-form-item label="行动释义" prop="xdsy"><el-input type="textarea" v-model.number="modalForm.xdsy" ></el-input></el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        xdsy: [{ required: true, message: '行动释义不能为空', trigger: ' ' }],
      },
      importModal: {
        title: '批量上传', // 标题
        isShow: false, // 是否显示
